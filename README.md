...
**⚠️ Make sure you are setting the seeding options to 0 during LBRY setup, and not allowing LBRY to seed all viewed content (and that these options save). If not done, this will double the storage needed and has other possible legal implications regarding redistributing 3D printable firearm designs (this is typically location dependent, but I am not a lawyer)**
